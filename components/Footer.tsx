  ...
  return (
    <footer >
      <div className='flex items-center justify-center'>
        <img className='items-center justify-center cursor-pointer w-44 sm-22 hover:text-gray-400'
      ...
      <ul className="flex space-x-4">           
        <li>
        <button className="w-6 h-6 font-semibold text-black dark:text-white hover:text-gray-400 inline-flex items-center space-x-2 rounded">
...
<li>
  <div className="w-6 h-6 text-black dark:text-white hover:text-gray-400 cursor-pointer" >
    <img
...
<li>  
  <button className="w-6 h-6 text-black dark:text-white  hover:text-gray-400 cursor-pointer">
  ...
  <li>
  <SearchIcon className="w-6 h-6 md:inline-flex-start text-black hover:text-gray-400 dark:text-white cursor-pointer"></SearchIcon>
  </li>
            </ul>
      </div>
<div>
    <h3 className='p-8 flex items-start justify-start text-gray-400 dark:text-white '>Mentions légales — Contact — Jobs</h3>
  </div> 
  <div className="flex items-end justify-end">
  <button 
className="justufy-left text-black dark:text-white cursor-pointer border border-radius border-black dark:border-white px-4 py-4 rounded-full">
...
<div>
    <h3 className='flex items-center justify-center text-gray-400 dark:text-white'>© Nouvelle Ecole Media 2022</h3>
    </div>
       </footer>
  )
}
