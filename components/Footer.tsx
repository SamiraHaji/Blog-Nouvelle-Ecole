  ...
  return (
    <footer >
      <div className='flex items-center justify-center'>
        <img className='items-center justify-center cursor-pointer w-44 sm-22 hover:text-gray-400 dark:hover:text-gray-400'
...
<li>  
  ...
  <li>
  <SearchIcon className="w-6 h-6 md:inline-flex-start text-black hover:text-gray-400 dark:hover:text-gray-400 dark:text-white cursor-pointer"></SearchIcon>
  </li>
            </ul>
      </div>
<div>
    <h3 className='p-8 flex items-start justify-start text-gray-400 dark:text-white dark:hover:text-gray-400 '>Mentions légales — Contact — Jobs</h3>
  </div> 
<div>
    <h3 className='flex items-center justify-center text-gray-400 dark:text-white dark:hover:text-gray-400'>© Nouvelle Ecole Media 2022</h3>
    </div>
       </footer>
  )
}
