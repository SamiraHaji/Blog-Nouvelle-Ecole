  ...
  return (
    <header className="flex justify-between p-5 max-w-7xl mx-auto">
      <div className="flex items-center space-x-5">
        <Link href="/">
          <img
            className="w-32 object-contain cursor-pointer hover:scale-125"
      ...
      <div className="flex items-center space-x-5">
        <div className="flex gap-5">
          {renderThemeChanger()}
          <SearchIcon
            className="w-6 h-6  md:inline-flex hidden  text-black dark:text-white hover:text-gray-400 dark:hover:text-gray-500 cursor-pointer"
            onClick={() => setIsOpenSearch(true)}
          />
          <MenuIcon
            className="w-6 h-6 md:hidden text-black dark:text-white hover:text-gray-400 dark:hover:text-gray-500 cursor-pointer"
      ...
      {IsOpenSearch ? (
        <div className="flex items-center justify-center  bg-[#f4fafad6] max-auto overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full h-full md:inset-0 h-modal md:h-full">
